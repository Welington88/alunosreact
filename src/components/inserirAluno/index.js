...
function App() {
  const baseUrl="http://localhost:5090/api/Alunos";
  // estados do modais
    ...
    <div className="aluno-container">
      ...
      <tbody>
        {
            data.map(aluno=>(
              ...
              <td>
                ...
                <button className="btn btn-danger" onClick={() => selecionarAluno(aluno,"Excluir")} >Excluir</button> </td>
              </tr>
            ))}
      </tbody>
    </table>
      ...
      <Modal isOpen={modalIncluir}>
        ...
        <ModalBody>
            <div className="form-group">
              <label>Nome:</label><br/>
              <input type="text" className="formy-control" name="nome" onChange={handleChange} /><br/>
      ...
      <Modal isOpen={modalEditar}>
        ...
        <ModalBody>
            <div className="form-group">
            <label>ID:</label><br/> 
               <input type="text" className="formy-control" readOnly value={alunoSelecionado && alunoSelecionado.id} /><br/>
              <label>Nome:</label><br/>
              <input type="text" className="formy-control" name="nome" onChange={handleChange} 
